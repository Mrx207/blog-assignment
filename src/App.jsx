...
function App() {
  const { formDataHistory } = userContext();
  return (
    <>
      {" "}
      <Navbar />
      ...
      <div className="row mx-3">
        <div className="col-9">
          ...
          <p>
            Gravida dictum fusce ut placerat. Ornare quam viverra orci sagittis
          ...
          <p>
            ...
            dictum fusce ut placerat. Ornare quam viverra orci sagittis eu
          ...
          {formDataHistory.map(({ title, content }, index) => (
            <Blog title={title} content={content} key={index} />
          ))}
        </div>
        ...
        <div className="col-1">
          ...
          <p>
            ...
            dictum varius duis at. Vitae auctor eu augue ut. Neque vitae tempus
            quam pellentesque nec. Ipsum dolor sit amet consectetur. Habitasse
            platea dictumst quisque sagittis purus sit amet volutpat. Et tortor
            consequat id porta
          </p>
